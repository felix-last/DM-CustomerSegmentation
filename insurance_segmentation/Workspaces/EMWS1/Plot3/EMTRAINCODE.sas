...
proc gchart
data=EMWS1.Filter_TRAIN gout=WORK.Plot3GRAPH;
*;
title "ClaimsRate";
vbar ClaimsRate /
...
*------------------------------------------------------------*;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\ClaimsRate.gif";
...
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\CustomerMonetaryValue.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay CUSTOMER;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\IMP_EducationalDegree.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay IMP_EDUC;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\IMP_FirstPolicyYear.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay IMP_FIRS;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\IMP_GeographicLiving.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay IMP_GEOG;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\IMP_GrossMonthlySalary.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay IMP_GROS;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\IMP_HasChildren.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay IMP_HASC;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\IMP_PremiumsinLOBLife.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay IMP_PRE1;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\IMP_PremiumsinLOBMotor.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay IMP_PRE2;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\IMP_PremiumsinLOBWorkComp.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay IMP_PRE3;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\IMP_PremiumsinLOBHealth.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay IMP_PREM;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\IMP_REP_FirstPolicyYear.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay IMP_REP1;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\IMP_REP_CustomerAge.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay IMP_REP_;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\LOYALTY.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay LOYALTY;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\PremiumsinLOBHousehold.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay PREMIUMS;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "C:\Users\D059331\Desktop\DM_Insurance_segmentation\insurance_segmentation\Workspaces\EMWS1\Plot3\GRAPH\TOTAL_PREMIUM.gif";
goptions device= GIF display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT3GRAPH nofs;
replay TOTAL_PR;
quit;
